...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description="Legacy single-factor analysis example; not the replication entrypoint."
    )
    parser.add_argument("--input", required=True, help="CSV with date, symbol and factor1")
